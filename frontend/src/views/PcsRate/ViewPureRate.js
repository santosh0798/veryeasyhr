...
const ViewPureRate = () => {
    ...
    return (
        <StyledMainCard>
            <AttendanceTopbar name="Pure Pcs Rate" sea date="true" filter="true" salaryformat="true" wagesformat="true" parentCallback2={handleDate}/>
            <hr color="#fdfdfd"/>
